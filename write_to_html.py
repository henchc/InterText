...
def write_to_html(matches, ntext1, ntext2):
    # write html output
    ...
    for i, item in enumerate(matches):
        ...
        if pos != -1:
            ntext2 = ntext2[:pos] + '<a name="inttb' + str(i) + '"></a><h4 style="color:red;">(' + str(i) + ") " + ntext2[pos:pos + len(item[1])] + '<a href="#intta' + str(i) + '"> (' + f1name + ')</a></h4>' + ntext2[pos + len(item[1]):]
    ...
    with open(f1name + " " + f2name + ".html", 'w') as f:
        f.write(html)
